...
static void display_title(void) {
	...
	ShowMessage("" CL_PASS "       " CL_BT_WHITE "      __   bAthena Development Team presents                  " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	...
	ShowMessage("" CL_PASS "     " CL_BOLD "       /_____/_/  |_\\__/_/ /_/\\___/_/ /_/\\__,_/                  " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                                 " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "       " CL_GREEN "              http://www.bathena.com                        " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                                 " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
